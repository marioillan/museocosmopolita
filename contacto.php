...
<head>
    ...
    <meta charset="utf-8">
    <title>Museo Cosmopolita - Contacto </title>
    <link rel = "stylesheet" type = "text/css" href = "css/contacto.css"/>
    <link rel = "stylesheet" type = "text/css" href = "css/base.css"/>
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Lato:ital,wght@0,100;0,300;0,400;0,700;0,900;1,100;1,300;1,400;1,700;1,900&display=swap" rel="stylesheet"> <!--Para la fuente de letra--> 
    <link href='https://unpkg.com/boxicons@2.1.4/css/boxicons.min.css' rel='stylesheet'> <!--Para obtener los iconos del register-->
...
<main>
    ...
    <div class="caja-texto">
        ...
        <h1>Datos del Desarrollador de la Web</h1>

        <p>Esta página ha sido desarrollada por el estudiante Mario Illán Valero</p>

        <ul>
            <li>Nombre: Mario</li>
            <li>Apellidos: Illán Valero</li>
            <li>Edad: 22 años</li>
            <li>Estudios: Estudiante de Ingeniería Informática en la Universidad de Granada</li>
            <li>Correo: <a href="mailto:marioillval@gmail.com<">marioillval@gmail.com</a></li>
            <li>Teléfono: <a href="tel:639468882<">639468882</a></li>
        </ul>

        <h2>Enlaces</h2>

        <div class="logos-enlaces">
    ...
    <div class="foto">
        ...
        <img src="imagenes/imagen_estudiante.jpeg" alt="Imagen Programador">
